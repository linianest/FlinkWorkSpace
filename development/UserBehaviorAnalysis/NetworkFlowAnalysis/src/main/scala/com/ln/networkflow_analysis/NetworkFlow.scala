package com.ln.networkflow_analysis
...
object NetworkFlow {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val dataStream = env.readTextFile("E:\\FlinkWorkSpace\\development\\UserBehaviorAnalysis\\NetworkFlowAnalysis\\src\\main\\resources\\apache.log")
      .map(data => {
