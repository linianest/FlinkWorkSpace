package com.ln.loginfail_detect
...
object LoginFailWithCep {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 1. 读取事件数据，创建简单事件流
    val loginEventStream = env.readTextFile("E:\\FlinkWorkSpace\\development\\UserBehaviorAnalysis\\LoginFailDetect\\src\\main\\resources\\LoginLog.csv")
      .map(data => {
