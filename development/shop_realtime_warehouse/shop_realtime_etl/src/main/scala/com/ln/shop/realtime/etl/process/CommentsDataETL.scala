...
import com.ln.shop.realtime.etl.bean.{CommentsEntity, CommentsWideEntity, DimGoodsDBEntity}
import com.ln.shop.realtime.etl.utils.{DateUtil, GlobalConfigUtil, RedisUtil}
