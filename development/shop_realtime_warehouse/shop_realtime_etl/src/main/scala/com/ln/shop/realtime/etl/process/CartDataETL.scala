package com.ln.shop.realtime.etl.process
...
import com.ln.shop.realtime.etl.`trait`.MQBaseETL
import com.ln.shop.realtime.etl.bean.{CartEntity, CartWideEntity, DimGoodsCatDBEntity, DimGoodsDBEntity, DimOrgDBEntity, DimShopDBEntity}
import com.ln.shop.realtime.etl.utils.{GlobalConfigUtil, HBaseUtil, RedisUtil}
