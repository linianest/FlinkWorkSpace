package com.ln.shop.realtime.etl.async

import java.util

import com.ln.canal.bean.CanalRowData
import com.ln.shop.realtime.etl.bean.{DimGoodsCatDBEntity, DimGoodsDBEntity, DimOrgDBEntity, DimShopDBEntity, OrderGoodsWideDBEntity}
