...
import com.ln.shop.realtime.etl.bean.{DimGoodsCatDBEntity, DimGoodsDBEntity, DimOrgDBEntity, DimShopCatDBEntity, DimShopDBEntity}
import com.ln.shop.realtime.etl.utils.RedisUtil
