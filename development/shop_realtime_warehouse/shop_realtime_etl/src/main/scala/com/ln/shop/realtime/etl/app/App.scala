package com.ln.shop.realtime.etl.app
...
import com.ln.shop.realtime.etl.process.{CartDataETL, ClickLogDataETL, CommentsDataETL, GoodsDataETL, OderDetailDataETL, OrderDataETL, SyncDimData}
import com.ln.shop.realtime.etl.utils.GlobalConfigUtil
...
object App {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //设置checkpoint 的间隔时间为5秒
    env.enableCheckpointing(5000)
    // 当任务被取消时，保留以前的checkpoint,避免数据丢失
