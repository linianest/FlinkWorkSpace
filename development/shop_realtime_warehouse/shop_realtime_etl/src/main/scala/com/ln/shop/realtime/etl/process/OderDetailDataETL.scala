...
import com.ln.shop.realtime.etl.`trait`.MysqlBaseETL
import com.ln.shop.realtime.etl.async.AsyncOrderDetailRedisRequest
import com.ln.shop.realtime.etl.bean.OrderGoodsWideDBEntity
import com.ln.shop.realtime.etl.utils.{GlobalConfigUtil, HBaseUtil}
